const timeline_items = [
  ...
  },
  {
    ...
    points: [
      ...
      "Studied business technology management",
      "Earned a bachelor's degree with a 3.7 gpa in business technology management major and a 3.0 GPA overall.",
      [
        "Example of classes I took:",
        [
          "Introduction to Business Applicant Development(C#)",
          "Database Management(MySQL)",
          "Information Systems Analysis/ Design and Implementation/ Strategy, Management, and Sourcing",
